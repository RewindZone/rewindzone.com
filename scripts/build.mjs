...
write('about/index.html', layout({
  title: 'About',
  description: 'About RewindZone and its film and television archive.',
  canonicalPath: '/about/',
  body: `<main id="main"><header class="page-header"><div class="eyebrow">About</div><h1>RewindZone</h1></header><div class="page-copy"><p>RewindZone is an independent archive of writing about film, television and popular culture.</p><p>The site preserves the original articles in a simple, text-first format designed to be quick to read and easy to revisit.</p></div></main>`,
}))
